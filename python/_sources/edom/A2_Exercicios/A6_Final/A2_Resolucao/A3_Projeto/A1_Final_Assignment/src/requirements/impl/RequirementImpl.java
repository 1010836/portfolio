 ...
 *   <li>{@link requirements.impl.RequirementImpl#getComment <em>Comment</em>}</li>
...
public class RequirementImpl extends MinimalEObjectImpl.Container implements Requirement {
	...
	public EList<Comment> getComment() {
		if (comment == null) {
			comment = new EObjectContainmentEList<Comment>(Comment.class, this, RequirementsPackage.REQUIREMENT__COMMENT);
		}
		return comment;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RequirementsPackage.REQUIREMENT__COMMENT:
