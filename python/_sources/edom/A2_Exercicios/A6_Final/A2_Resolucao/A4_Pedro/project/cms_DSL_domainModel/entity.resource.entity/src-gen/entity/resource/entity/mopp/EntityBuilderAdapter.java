...
public class EntityBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "entity.resource.entity.builder";
	
	private entity.resource.entity.IEntityBuilder defaultBuilder = new entity.resource.entity.mopp.EntityBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		entity.resource.entity.IEntityBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			entity.resource.entity.mopp.EntityResource customResource = (entity.resource.entity.mopp.EntityResource) resourceSet.getResource(uri, true);
			new entity.resource.entity.mopp.EntityMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public entity.resource.entity.IEntityBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new entity.resource.entity.mopp.EntityMarkerHelper().getMarkerID(entity.resource.entity.EntityEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		entity.resource.entity.mopp.EntityTaskItemBuilder taskItemBuilder = new entity.resource.entity.mopp.EntityTaskItemBuilder();
		new entity.resource.entity.mopp.EntityMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new entity.resource.entity.mopp.EntityMetaInformation().getSyntaxName())) {
