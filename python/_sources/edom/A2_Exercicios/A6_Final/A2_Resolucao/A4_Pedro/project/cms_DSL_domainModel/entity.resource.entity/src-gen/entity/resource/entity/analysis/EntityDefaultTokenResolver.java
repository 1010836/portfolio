 ...
 */
public class EntityDefaultTokenResolver implements entity.resource.entity.IEntityTokenResolver {
	 ...
	 */
	public EntityDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public EntityDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, entity.resource.entity.IEntityTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : entity.resource.entity.grammar.EntityGrammarInformationProvider.INSTANCE.getKeywords()) {
