...
public interface IEntityOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new entity.resource.entity.mopp.EntityMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new entity.resource.entity.mopp.EntityMetaInformation().getResourcePostProcessorProviderOptionKey();
