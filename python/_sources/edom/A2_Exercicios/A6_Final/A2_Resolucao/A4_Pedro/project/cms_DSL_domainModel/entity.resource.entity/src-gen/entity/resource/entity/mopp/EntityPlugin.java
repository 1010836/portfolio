 ...
 */
public class EntityPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "entity.resource.entity";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, EntityPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, EntityPlugin.PLUGIN_ID, message);
		}
		final EntityPlugin pluginInstance = EntityPlugin.getDefault();
