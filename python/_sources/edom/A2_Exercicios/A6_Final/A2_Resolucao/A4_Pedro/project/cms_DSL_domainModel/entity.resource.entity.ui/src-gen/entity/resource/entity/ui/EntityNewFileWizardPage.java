 ...
 */
public class EntityNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public EntityNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new entity file");
