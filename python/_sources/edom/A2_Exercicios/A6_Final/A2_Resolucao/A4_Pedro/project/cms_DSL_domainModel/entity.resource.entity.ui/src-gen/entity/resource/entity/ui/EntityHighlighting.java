 ...
 */
public class EntityHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static entity.resource.entity.ui.EntityPositionHelper positionHelper = new entity.resource.entity.ui.EntityPositionHelper();
	...
	private entity.resource.entity.ui.EntityTokenScanner scanner;
	...
	private entity.resource.entity.ui.EntityEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private entity.resource.entity.ui.EntityOccurrence occurrence;
	private entity.resource.entity.ui.EntityBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, entity.resource.entity.IEntityBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public EntityHighlighting(entity.resource.entity.IEntityTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, entity.resource.entity.ui.EntityColorManager colorManager, entity.resource.entity.ui.EntityEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = entity.resource.entity.ui.EntityUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new entity.resource.entity.ui.EntityTokenScanner(textResource, colorManager);
		occurrence = new entity.resource.entity.ui.EntityOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new entity.resource.entity.ui.EntityBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(entity.resource.entity.ui.EntityPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, entity.resource.entity.ui.EntityPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(entity.resource.entity.ui.EntityEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, entity.resource.entity.ui.EntityPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, entity.resource.entity.ui.EntityPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(entity.resource.entity.ui.EntityPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new entity.resource.entity.ui.EntityEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
