 ...
 */
public class EntitySyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public EntitySyntaxColoringPreferencePage() {
		super();
		
		entity.resource.entity.mopp.EntityMetaInformation metaInformation = new entity.resource.entity.mopp.EntityMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = entity.resource.entity.ui.EntitySyntaxColoringHelper.getPreferenceKey(languageID, tokenName, entity.resource.entity.ui.EntitySyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = entity.resource.entity.ui.EntitySyntaxColoringHelper.getPreferenceKey(languageID, tokenName, entity.resource.entity.ui.EntitySyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = entity.resource.entity.ui.EntitySyntaxColoringHelper.getPreferenceKey(languageID, tokenName, entity.resource.entity.ui.EntitySyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = entity.resource.entity.ui.EntitySyntaxColoringHelper.getPreferenceKey(languageID, tokenName, entity.resource.entity.ui.EntitySyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = entity.resource.entity.ui.EntitySyntaxColoringHelper.getPreferenceKey(languageID, tokenName, entity.resource.entity.ui.EntitySyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = entity.resource.entity.ui.EntitySyntaxColoringHelper.getPreferenceKey(languageID, tokenName, entity.resource.entity.ui.EntitySyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		entity.resource.entity.ui.EntityPixelConverter pixelConverter = new entity.resource.entity.ui.EntityPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof entity.resource.entity.ui.EntityEditor) {
			entity.resource.entity.ui.EntityEditor emfTextEditor = (entity.resource.entity.ui.EntityEditor) editor;
