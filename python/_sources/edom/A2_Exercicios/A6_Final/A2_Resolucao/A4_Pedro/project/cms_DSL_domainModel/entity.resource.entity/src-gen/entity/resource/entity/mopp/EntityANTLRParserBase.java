...
public abstract class EntityANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements entity.resource.entity.IEntityTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<entity.resource.entity.IEntityCommand<entity.resource.entity.IEntityTextResource>> postParseCommands;
	 ...
	 */
	private entity.resource.entity.mopp.EntityTokenResolveResult tokenResolveResult = new entity.resource.entity.mopp.EntityTokenResolveResult();
	...
	public EntityANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public EntityANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, entity.resource.entity.grammar.EntitySyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof entity.resource.entity.grammar.EntityPlaceholder;
		isElementToStore |= syntaxElement instanceof entity.resource.entity.grammar.EntityKeyword;
		isElementToStore |= syntaxElement instanceof entity.resource.entity.grammar.EntityEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof entity.resource.entity.grammar.EntityBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new entity.resource.entity.mopp.EntityLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
		this.lastPosition2 = (endPos < 0 ? 0 : endPos + 1);
		anonymousTokens.clear();
	}
	
	protected entity.resource.entity.mopp.EntityLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = entity.resource.entity.util.EntityStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(entity.resource.entity.IEntityOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(entity.resource.entity.IEntityOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, entity.resource.entity.mopp.EntityDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = entity.resource.entity.util.EntityMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof entity.resource.entity.mopp.EntityDummyEObject);
			entity.resource.entity.mopp.EntityDummyEObject dummy = (entity.resource.entity.mopp.EntityDummyEObject) object;
	...
	protected entity.resource.entity.mopp.EntityTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected entity.resource.entity.mopp.EntityReferenceResolverSwitch getReferenceResolverSwitch() {
		entity.resource.entity.mopp.EntityReferenceResolverSwitch resolverSwitch = (entity.resource.entity.mopp.EntityReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
