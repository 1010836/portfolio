...
public class EntityLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(entity.resource.entity.mopp.EntityPlugin.DEBUG_MODEL_ID);
			...
			entity.resource.entity.debug.EntityLineBreakpoint lineBreakpoint = new entity.resource.entity.debug.EntityLineBreakpoint(resource, lineNumber + 1);
