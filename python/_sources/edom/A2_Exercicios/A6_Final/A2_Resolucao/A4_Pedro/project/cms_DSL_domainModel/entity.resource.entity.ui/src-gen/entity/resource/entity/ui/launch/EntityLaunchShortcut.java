 ...
 */
public class EntityLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new entity.resource.entity.mopp.EntityMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(entity.resource.entity.launch.EntityLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			entity.resource.entity.mopp.EntityPlugin.logError("Exception while launching selection", e);
		}
	}
