...
public class EntityStackFrame extends entity.resource.entity.debug.EntityDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private entity.resource.entity.debug.EntityDebugTarget target;
	private String name;
	private int id;
	...
	public EntityStackFrame(entity.resource.entity.debug.EntityDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = entity.resource.entity.util.EntityStringUtil.decode(data, ',');
	...
	private entity.resource.entity.debug.EntityDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		entity.resource.entity.debug.EntityStackFrame other = (entity.resource.entity.debug.EntityStackFrame) obj;
		if (name == null) {
