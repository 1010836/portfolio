 ...
 * resolver
 */
public interface IEntityReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends entity.resource.entity.IEntityConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, entity.resource.entity.IEntityReferenceResolveResult<ReferenceType> result);
