 ...
 */
public class EntityEnumerationTerminal extends entity.resource.entity.grammar.EntityTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public EntityEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, entity.resource.entity.grammar.EntityCardinality cardinality, int mandatoryOccurrencesAfter) {
