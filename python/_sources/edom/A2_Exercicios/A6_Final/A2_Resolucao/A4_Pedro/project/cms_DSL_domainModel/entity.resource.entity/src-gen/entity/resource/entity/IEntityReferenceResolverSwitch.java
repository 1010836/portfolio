...
/**
 * A IEntityReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IEntityReferenceResolverSwitch extends entity.resource.entity.IEntityConfigurable {
