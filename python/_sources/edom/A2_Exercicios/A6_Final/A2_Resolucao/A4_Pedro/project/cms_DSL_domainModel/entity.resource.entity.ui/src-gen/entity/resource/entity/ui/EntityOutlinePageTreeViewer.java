 ...
 * a specified depth.
 */
public class EntityOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public EntityOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = entity.resource.entity.util.EntityStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof entity.resource.entity.ui.EntityEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			entity.resource.entity.mopp.EntityPlugin.logError("Exception while refreshing outline view", e);
		}
	}
