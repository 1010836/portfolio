 ...
 * @since 3.2
 */
public class EntityBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private entity.resource.entity.ui.EntityDocBrowserInformationControlInput fInput;
	 ...
	 */
	public EntityBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public EntityBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public EntityBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof entity.resource.entity.ui.EntityDocBrowserInformationControlInput);
		...
		fInput= (entity.resource.entity.ui.EntityDocBrowserInformationControlInput) input;
		...
		entity.resource.entity.ui.EntityHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = entity.resource.entity.ui.EntityHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public entity.resource.entity.ui.EntityDocBrowserInformationControlInput getInput() {
		return fInput;
	}
