 ...
 */
public class EntityBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final entity.resource.entity.IEntityTextResource resource, final entity.resource.entity.ui.EntityEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final entity.resource.entity.IEntityTextResource resource, final entity.resource.entity.ui.EntityEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final entity.resource.entity.IEntityTextResource resource, final entity.resource.entity.ui.EntityEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof entity.resource.entity.mopp.EntityResource) {
							entity.resource.entity.mopp.EntityResource concreteResource = (entity.resource.entity.mopp.EntityResource) resource;
