...
public class EntityDebugValue extends entity.resource.entity.debug.EntityDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public EntityDebugValue(entity.resource.entity.debug.EntityDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
