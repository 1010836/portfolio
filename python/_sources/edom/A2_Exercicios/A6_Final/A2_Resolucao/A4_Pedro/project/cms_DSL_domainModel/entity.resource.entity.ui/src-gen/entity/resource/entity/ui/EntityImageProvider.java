...
public class EntityImageProvider {
	...
	public final static EntityImageProvider INSTANCE = new EntityImageProvider();
	...
	public org.eclipse.jface.resource.ImageDescriptor getImageDescriptor(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(entity.resource.entity.ui.EntityUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				entity.resource.entity.ui.EntityUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
