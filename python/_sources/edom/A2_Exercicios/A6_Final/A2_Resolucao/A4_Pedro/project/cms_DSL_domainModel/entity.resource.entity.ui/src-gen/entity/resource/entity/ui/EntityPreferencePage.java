 ...
 */
public class EntityPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(entity.resource.entity.ui.EntityUIPlugin.getDefault().getPreferenceStore());
		setDescription("Entity Text Editor Preferences");
	}
