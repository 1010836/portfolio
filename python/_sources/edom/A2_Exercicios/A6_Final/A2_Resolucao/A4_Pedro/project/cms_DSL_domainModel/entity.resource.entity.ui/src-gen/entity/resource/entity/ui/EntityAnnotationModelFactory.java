...
public class EntityAnnotationModelFactory implements org.eclipse.core.filebuffers.IAnnotationModelFactory {
	...
	public org.eclipse.jface.text.source.IAnnotationModel createAnnotationModel(org.eclipse.core.runtime.IPath location) {
		...
		return new entity.resource.entity.ui.EntityAnnotationModel(resource);
	}
