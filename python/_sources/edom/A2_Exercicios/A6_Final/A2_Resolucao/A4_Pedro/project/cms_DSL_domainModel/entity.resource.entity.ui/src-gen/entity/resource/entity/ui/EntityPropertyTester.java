...
public class EntityPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new entity.resource.entity.mopp.EntityMetaInformation().getSyntaxName());
	}
