...
public class EntityNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "entity.resource.entity.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {entity.resource.entity.mopp.EntityBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(entity.resource.entity.mopp.EntityBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
