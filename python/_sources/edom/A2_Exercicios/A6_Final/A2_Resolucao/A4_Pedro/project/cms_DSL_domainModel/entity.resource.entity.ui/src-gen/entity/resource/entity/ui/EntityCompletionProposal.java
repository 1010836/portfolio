 ...
 */
public class EntityCompletionProposal implements java.lang.Comparable<EntityCompletionProposal> {
	 ...
	 */
	private entity.resource.entity.mopp.EntityExpectedTerminal expectedTerminal;
	...
	public EntityCompletionProposal(entity.resource.entity.mopp.EntityExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public EntityCompletionProposal(entity.resource.entity.mopp.EntityExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public EntityCompletionProposal(entity.resource.entity.mopp.EntityExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public entity.resource.entity.mopp.EntityExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof EntityCompletionProposal) {
			EntityCompletionProposal other = (EntityCompletionProposal) object;
	...
	public int compareTo(EntityCompletionProposal object) {
		if (object instanceof EntityCompletionProposal) {
			EntityCompletionProposal other = (EntityCompletionProposal) object;
