...
import basemindmap.BasemindmapFactory;
import basemindmap.BasemindmapPackage;
import basemindmap.Map;
import basemindmap.MapElement;
import basemindmap.Priority;
import basemindmap.Relationship;
import basemindmap.Topic;
import basemindmap.Type;

import basemindmap.util.BasemindmapValidator;
 ...
 * @generated
 */
public class BasemindmapPackageImpl extends EPackageImpl implements BasemindmapPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see basemindmap.BasemindmapPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BasemindmapPackageImpl() {
		super(eNS_URI, BasemindmapFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BasemindmapPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BasemindmapPackage init() {
		if (isInited) return (BasemindmapPackage)EPackage.Registry.INSTANCE.getEPackage(BasemindmapPackage.eNS_URI);

		// Obtain or create and register package
		BasemindmapPackageImpl theBasemindmapPackage = (BasemindmapPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BasemindmapPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BasemindmapPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theBasemindmapPackage.createPackageContents();

		// Initialize created meta-data
		theBasemindmapPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theBasemindmapPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return BasemindmapValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theBasemindmapPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BasemindmapPackage.eNS_URI, theBasemindmapPackage);
		return theBasemindmapPackage;
	}
	 ...
	 * @generated
	 */
	public BasemindmapFactory getBasemindmapFactory() {
		return (BasemindmapFactory)getEFactoryInstance();
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (topicEClass, 
		   source, 
		   new String[] {
			 "EndAfterStart", "self.end > self.start"
		   });	
		addAnnotation
		  (getTopic__AllSubTopics(), 
		   source, 
		   new String[] {
