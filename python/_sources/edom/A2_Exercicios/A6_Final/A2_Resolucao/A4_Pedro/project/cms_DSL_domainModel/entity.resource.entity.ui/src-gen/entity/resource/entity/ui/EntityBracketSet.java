...
public class EntityBracketSet {
	...
	private java.util.ArrayList<entity.resource.entity.IEntityBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements entity.resource.entity.IEntityBracketPair {
	 ...
	 */
	private class ClosingListener implements entity.resource.entity.ui.IEntityBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				entity.resource.entity.IEntityBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public EntityBracketSet(entity.resource.entity.ui.EntityEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new entity.resource.entity.mopp.EntityMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<entity.resource.entity.IEntityBracketPair>();
	 ...
	 */
	public entity.resource.entity.IEntityBracketPair getBracketPair(String opening, String closing) {
		for (entity.resource.entity.IEntityBracketPair bracketPair : bracketPairs) {
	...
	public entity.resource.entity.IEntityBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(entity.resource.entity.IEntityBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + entity.resource.entity.ui.EntityPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public entity.resource.entity.IEntityBracketPair remove(String opening, String closing) {
		for (entity.resource.entity.IEntityBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<entity.resource.entity.IEntityBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, entity.resource.entity.ui.EntityPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, entity.resource.entity.ui.EntityPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
