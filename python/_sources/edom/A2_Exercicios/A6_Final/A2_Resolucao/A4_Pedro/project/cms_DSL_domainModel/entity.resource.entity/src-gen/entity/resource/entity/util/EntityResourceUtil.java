...
public class EntityResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new entity.resource.entity.util.EntityInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new entity.resource.entity.util.EntityInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static entity.resource.entity.mopp.EntityResource getResource(java.io.File file) {
	...
	public static entity.resource.entity.mopp.EntityResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new entity.resource.entity.mopp.EntityMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (entity.resource.entity.mopp.EntityResource) resource;
	}
	 ...
	 */
	public static entity.Model getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static entity.Model getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (entity.Model) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static entity.Model getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		entity.resource.entity.IEntityTextResource resource = (entity.resource.entity.IEntityTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (entity.resource.entity.IEntityTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		entity.resource.entity.IEntityTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
