 ...
 */
public class EntityNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new entity.resource.entity.mopp.EntityMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("entity.resource.entity.ui");
							...
							String natureID = entity.resource.entity.mopp.EntityNature.NATURE_ID;
							...
							for (String builderID : entity.resource.entity.mopp.EntityNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								entity.resource.entity.mopp.EntityMetaInformation info = new entity.resource.entity.mopp.EntityMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = entity.resource.entity.ui.EntityUIPlugin.getDefault().getBundle();
