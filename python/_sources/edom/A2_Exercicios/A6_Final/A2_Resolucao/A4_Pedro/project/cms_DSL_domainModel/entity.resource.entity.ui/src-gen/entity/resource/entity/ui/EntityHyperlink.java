 ...
 */
public class EntityHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public EntityHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				entity.resource.entity.mopp.EntityPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
