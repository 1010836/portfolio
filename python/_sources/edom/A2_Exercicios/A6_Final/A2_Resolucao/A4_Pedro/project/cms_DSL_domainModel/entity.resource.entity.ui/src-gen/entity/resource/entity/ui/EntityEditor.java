...
/**
 * A text editor for 'entity' models.
 * <p>
 * This editor has id <code>entity.resource.entity.ui.EntityEditor</code>
 * The editor's context menu has id
 * <code>entity.resource.entity.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>entity.resource.entity.EditorRuler</code>.
 * </p>
 */
public class EntityEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, entity.resource.entity.IEntityResourceProvider, entity.resource.entity.ui.IEntityBracketHandlerProvider, entity.resource.entity.ui.IEntityAnnotationModelProvider {
	
	private entity.resource.entity.ui.EntityHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private entity.resource.entity.ui.EntityCodeFoldingManager codeFoldingManager;
	private entity.resource.entity.ui.EntityBackgroundParsingStrategy bgParsingStrategy = new entity.resource.entity.ui.EntityBackgroundParsingStrategy();
	private java.util.Collection<entity.resource.entity.IEntityBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<entity.resource.entity.IEntityBackgroundParsingListener>();
	private entity.resource.entity.ui.EntityColorManager colorManager = new entity.resource.entity.ui.EntityColorManager();
	private entity.resource.entity.ui.EntityOutlinePage outlinePage;
	...
	private entity.resource.entity.ui.EntityPropertySheetPage propertySheetPage;
	...
	private entity.resource.entity.ui.IEntityBracketHandler bracketHandler;
	...
	public EntityEditor() {
		super();
		setSourceViewerConfiguration(new entity.resource.entity.ui.EntitySourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), EntityEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								entity.resource.entity.IEntityTextResource currentResource = getResource();
				...
				entity.resource.entity.ui.EntityUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("entity.resource.entity.EditorContext");
		setRulerContextMenuId("entity.resource.entity.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new entity.resource.entity.ui.EntityHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new entity.resource.entity.ui.EntityCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		entity.resource.entity.mopp.EntityNature.activate(inputFile.getProject());
		...
		entity.resource.entity.IEntityTextResource loadedResource = (entity.resource.entity.IEntityTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				entity.resource.entity.IEntityTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof entity.resource.entity.IEntityTextResource) {
					setResource((entity.resource.entity.IEntityTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					entity.resource.entity.ui.EntityUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the EntityEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				entity.resource.entity.ui.EntityUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(entity.resource.entity.IEntityTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new entity.resource.entity.ui.EntityOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new entity.resource.entity.ui.EntityPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			entity.resource.entity.IEntityTextResource textResource = (entity.resource.entity.IEntityTextResource) element.eResource();
			entity.resource.entity.IEntityLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			entity.resource.entity.IEntityTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				entity.resource.entity.IEntityTextToken token = lexer.getNextToken();
			...
			entity.resource.entity.ui.EntityUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!EntityEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(entity.resource.entity.IEntityBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (entity.resource.entity.IEntityBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public entity.resource.entity.ui.IEntityBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(entity.resource.entity.ui.IEntityBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof entity.resource.entity.IEntityTextResource)) {
					return false;
				}
				entity.resource.entity.IEntityTextResource textResource = (entity.resource.entity.IEntityTextResource) resource;
				entity.resource.entity.IEntityLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
