 ...
 * olInput</code>.
 */
public class EntityDocBrowserInformationControlInput {
	
	private final EntityDocBrowserInformationControlInput fPrevious;
	private EntityDocBrowserInformationControlInput fNext;
	 ...
	 */
	public EntityDocBrowserInformationControlInput(EntityDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public EntityDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public EntityDocBrowserInformationControlInput getNext() {
		return fNext;
	}
