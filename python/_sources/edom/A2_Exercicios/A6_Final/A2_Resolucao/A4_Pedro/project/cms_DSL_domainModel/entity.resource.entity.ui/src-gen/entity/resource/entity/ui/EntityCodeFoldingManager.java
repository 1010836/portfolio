 ...
 */
public class EntityCodeFoldingManager {
	
	private class FoldingUpdateListener implements entity.resource.entity.IEntityBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(entity.resource.entity.ui.EntityEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof entity.resource.entity.ui.EntityEditor) {
				entity.resource.entity.ui.EntityEditor editor = (entity.resource.entity.ui.EntityEditor) workbenchPart;
	...
	protected entity.resource.entity.ui.EntityEditor editor;
	 ...
	 */
	public EntityCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,entity.resource.entity.ui.EntityEditor textEditor) {
	...
	private void addCloseListener(final entity.resource.entity.ui.EntityEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			entity.resource.entity.ui.EntityUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		entity.resource.entity.IEntityTextResource textResource = (entity.resource.entity.IEntityTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
