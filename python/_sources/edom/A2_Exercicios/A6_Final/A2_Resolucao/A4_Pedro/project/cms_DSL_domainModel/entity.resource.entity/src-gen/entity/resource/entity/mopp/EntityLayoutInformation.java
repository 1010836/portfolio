...
/**
 * EntityLayoutInformation objects are used to store layout information that is
 ...
 * EntityLayoutInformations are aggregated in LayoutInformationAdapters. One
 * EntityLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class EntityLayoutInformation {
	 ...
	 */
	private final entity.resource.entity.grammar.EntitySyntaxElement syntaxElement;
	...
	public EntityLayoutInformation(entity.resource.entity.grammar.EntitySyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public entity.resource.entity.grammar.EntitySyntaxElement getSyntaxElement() {
