...
public class EntityLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "entity.resource.entity.debug.lineBreakpoint.marker";
	
	public EntityLineBreakpoint() {
		super();
	}
	
	public EntityLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(entity.resource.entity.debug.EntityDebugTarget target) {
		try {
	...
	public void remove(entity.resource.entity.debug.EntityDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
