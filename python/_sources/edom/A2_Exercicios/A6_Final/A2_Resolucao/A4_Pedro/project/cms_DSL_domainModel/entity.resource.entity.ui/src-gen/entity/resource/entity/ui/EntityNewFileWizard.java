...
public class EntityNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private entity.resource.entity.ui.EntityNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public EntityNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new entity.resource.entity.ui.EntityNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			entity.resource.entity.ui.EntityUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			entity.resource.entity.ui.EntityUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new entity.resource.entity.mopp.EntityMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new entity.resource.entity.mopp.EntityMetaInformation().getSyntaxName();
	}
