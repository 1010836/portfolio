 ...
 * contains <code>entity.resource.entity.IEntityTextDiagnostic</code>s it uses the
 * more precise information of this extended diagnostic type.
 */
public class EntityMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = entity.resource.entity.mopp.EntityPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<entity.resource.entity.IEntityCommand<Object>> commands = new java.util.ArrayList<entity.resource.entity.IEntityCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(entity.resource.entity.IEntityCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<entity.resource.entity.IEntityCommand<Object>> commandsToProcess = new java.util.ArrayList<entity.resource.entity.IEntityCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (entity.resource.entity.IEntityCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, entity.resource.entity.IEntityTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final entity.resource.entity.IEntityTextDiagnostic diagnostic) {
		final entity.resource.entity.IEntityProblem problem = diagnostic.getProblem();
		entity.resource.entity.EntityEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new entity.resource.entity.IEntityCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == entity.resource.entity.EntityEProblemSeverity.ERROR) {
					...
					entity.resource.entity.IEntityTextDiagnostic textDiagnostic = (entity.resource.entity.IEntityTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof entity.resource.entity.mopp.EntityResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((entity.resource.entity.mopp.EntityResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<entity.resource.entity.IEntityQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, entity.resource.entity.util.EntityStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (entity.resource.entity.EntityEProblemType nextType : entity.resource.entity.EntityEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, entity.resource.entity.EntityEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(entity.resource.entity.EntityEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(entity.resource.entity.EntityEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new entity.resource.entity.util.EntityRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new entity.resource.entity.IEntityCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					entity.resource.entity.mopp.EntityPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
