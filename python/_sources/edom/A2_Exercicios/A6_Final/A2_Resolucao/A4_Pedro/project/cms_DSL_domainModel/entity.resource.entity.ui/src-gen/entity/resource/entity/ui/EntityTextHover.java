 ...
 */
public class EntityTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	
	private static final String FONT = org.eclipse.jface.resource.JFaceResources.DIALOG_FONT;
	
	private entity.resource.entity.IEntityResourceProvider resourceProvider;
	private entity.resource.entity.IEntityHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final entity.resource.entity.ui.EntityBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(entity.resource.entity.ui.EntityBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			entity.resource.entity.ui.EntityDocBrowserInformationControlInput infoInput = (entity.resource.entity.ui.EntityDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					entity.resource.entity.ui.EntityHyperlink hyperlink = new entity.resource.entity.ui.EntityHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (entity.resource.entity.ui.EntityBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				entity.resource.entity.ui.EntityBrowserInformationControl iControl = new entity.resource.entity.ui.EntityBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof entity.resource.entity.ui.EntityDocBrowserInformationControlInput) {
							entity.resource.entity.ui.EntityDocBrowserInformationControlInput input = (entity.resource.entity.ui.EntityDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (entity.resource.entity.ui.EntityBrowserInformationControl.isAvailable(parent)) {
				entity.resource.entity.ui.EntityBrowserInformationControl iControl = new entity.resource.entity.ui.EntityBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public EntityTextHover(entity.resource.entity.IEntityResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new entity.resource.entity.ui.EntityUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((entity.resource.entity.ui.EntityDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private entity.resource.entity.ui.EntityDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		entity.resource.entity.IEntityTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private entity.resource.entity.ui.EntityDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, entity.resource.entity.ui.EntityDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				entity.resource.entity.ui.EntityHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			entity.resource.entity.ui.EntityHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			entity.resource.entity.ui.EntityHTMLPrinter.insertPageProlog(buffer, 0, entity.resource.entity.ui.EntityTextHover.getStyleSheet());
			entity.resource.entity.ui.EntityHTMLPrinter.addPageEpilog(buffer);
			return new entity.resource.entity.ui.EntityDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = entity.resource.entity.ui.EntityHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(entity.resource.entity.ui.EntityUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return entity.resource.entity.util.EntityStreamUtil.getContent(styleSheetURL.openStream());
