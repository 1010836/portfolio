 ...
 */
public class EntityRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			entity.resource.entity.mopp.EntityPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			entity.resource.entity.mopp.EntityPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
