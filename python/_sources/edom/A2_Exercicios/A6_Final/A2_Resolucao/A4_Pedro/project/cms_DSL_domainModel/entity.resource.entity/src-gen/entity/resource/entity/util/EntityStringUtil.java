...
public class EntityStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, entity.resource.entity.IEntityFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, entity.resource.entity.IEntityFunction1<String, T> toStringFunction) {
