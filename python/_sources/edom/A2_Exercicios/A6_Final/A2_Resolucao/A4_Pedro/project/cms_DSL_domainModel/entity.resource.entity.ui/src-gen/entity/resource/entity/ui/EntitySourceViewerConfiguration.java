 ...
 */
public class EntitySourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private entity.resource.entity.ui.EntityQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public EntitySourceViewerConfiguration(entity.resource.entity.IEntityResourceProvider resourceProvider, entity.resource.entity.ui.IEntityAnnotationModelProvider annotationModelProvider, entity.resource.entity.ui.IEntityBracketHandlerProvider bracketHandlerProvider, entity.resource.entity.ui.EntityColorManager colorManager) {
		super(entity.resource.entity.ui.EntityUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new entity.resource.entity.ui.EntityCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new entity.resource.entity.ui.EntityTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new entity.resource.entity.ui.EntityTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new entity.resource.entity.ui.EntityHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new entity.resource.entity.ui.EntityQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new entity.resource.entity.ui.EntityIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
