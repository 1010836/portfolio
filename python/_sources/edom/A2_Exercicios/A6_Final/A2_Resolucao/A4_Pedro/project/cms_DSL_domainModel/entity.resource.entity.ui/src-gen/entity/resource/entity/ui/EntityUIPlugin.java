 ...
 */
public class EntityUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "entity.resource.entity.ui";
	public static final String EDITOR_ID = "entity.resource.entity.ui.EntityEditor";
	...
	private static EntityUIPlugin plugin;
	
	public EntityUIPlugin() {
		super();
	}
	...
	public static EntityUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EntityUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EntityUIPlugin.PLUGIN_ID, message);
		}
		final EntityUIPlugin pluginInstance = EntityUIPlugin.getDefault();
