 ...
 * hovers, is a proxy.
 */
public class EntityHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public EntityHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (entity.resource.entity.IEntityTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new entity.resource.entity.ui.EntityHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
