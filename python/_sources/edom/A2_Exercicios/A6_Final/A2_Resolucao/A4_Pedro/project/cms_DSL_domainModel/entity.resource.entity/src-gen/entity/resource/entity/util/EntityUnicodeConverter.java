 ...
 * to 4 bytes).
 */
public class EntityUnicodeConverter extends entity.resource.entity.mopp.EntityInputStreamProcessor {
	 ...
	 */
	public EntityUnicodeConverter(java.io.InputStream inputStream) {
