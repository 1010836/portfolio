 ...
 * @generated
 */
public class BaserequirementsPackageImpl extends EPackageImpl implements BaserequirementsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see baserequirements.BaserequirementsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BaserequirementsPackageImpl() {
		super(eNS_URI, BaserequirementsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BaserequirementsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BaserequirementsPackage init() {
		if (isInited) return (BaserequirementsPackage)EPackage.Registry.INSTANCE.getEPackage(BaserequirementsPackage.eNS_URI);

		// Obtain or create and register package
		BaserequirementsPackageImpl theBaserequirementsPackage = (BaserequirementsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BaserequirementsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BaserequirementsPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theBaserequirementsPackage.createPackageContents();

		// Initialize created meta-data
		theBaserequirementsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBaserequirementsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BaserequirementsPackage.eNS_URI, theBaserequirementsPackage);
		return theBaserequirementsPackage;
	}
	 ...
	 * @generated
	 */
	public BaserequirementsFactory getBaserequirementsFactory() {
		return (BaserequirementsFactory)getEFactoryInstance();
	}
