...
/**
 * A text editor for 'baserequirements' models.
 * <p>
 * This editor has id
 * <code>baserequirements.resource.baserequirements.ui.BaserequirementsEditor</code
 * >
 * The editor's context menu has id
 * <code>baserequirements.resource.baserequirements.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>baserequirements.resource.baserequirements.EditorRuler</code>.
 * </p>
 */
public class BaserequirementsEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, baserequirements.resource.baserequirements.IBaserequirementsResourceProvider, baserequirements.resource.baserequirements.ui.IBaserequirementsBracketHandlerProvider, baserequirements.resource.baserequirements.ui.IBaserequirementsAnnotationModelProvider {
	
	private baserequirements.resource.baserequirements.ui.BaserequirementsHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private baserequirements.resource.baserequirements.ui.BaserequirementsCodeFoldingManager codeFoldingManager;
	private baserequirements.resource.baserequirements.ui.BaserequirementsBackgroundParsingStrategy bgParsingStrategy = new baserequirements.resource.baserequirements.ui.BaserequirementsBackgroundParsingStrategy();
	private java.util.Collection<baserequirements.resource.baserequirements.IBaserequirementsBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<baserequirements.resource.baserequirements.IBaserequirementsBackgroundParsingListener>();
	private baserequirements.resource.baserequirements.ui.BaserequirementsColorManager colorManager = new baserequirements.resource.baserequirements.ui.BaserequirementsColorManager();
	private baserequirements.resource.baserequirements.ui.BaserequirementsOutlinePage outlinePage;
	...
	private baserequirements.resource.baserequirements.ui.BaserequirementsPropertySheetPage propertySheetPage;
	...
	private baserequirements.resource.baserequirements.ui.IBaserequirementsBracketHandler bracketHandler;
	...
	public BaserequirementsEditor() {
		super();
		setSourceViewerConfiguration(new baserequirements.resource.baserequirements.ui.BaserequirementsSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), BaserequirementsEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								baserequirements.resource.baserequirements.IBaserequirementsTextResource currentResource = getResource();
				...
				baserequirements.resource.baserequirements.ui.BaserequirementsUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("baserequirements.resource.baserequirements.EditorContext");
		setRulerContextMenuId("baserequirements.resource.baserequirements.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new baserequirements.resource.baserequirements.ui.BaserequirementsHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new baserequirements.resource.baserequirements.ui.BaserequirementsCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		baserequirements.resource.baserequirements.mopp.BaserequirementsNature.activate(inputFile.getProject());
		...
		baserequirements.resource.baserequirements.IBaserequirementsTextResource loadedResource = (baserequirements.resource.baserequirements.IBaserequirementsTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				baserequirements.resource.baserequirements.IBaserequirementsTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof baserequirements.resource.baserequirements.IBaserequirementsTextResource) {
					setResource((baserequirements.resource.baserequirements.IBaserequirementsTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					baserequirements.resource.baserequirements.ui.BaserequirementsUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the BaserequirementsEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				baserequirements.resource.baserequirements.ui.BaserequirementsUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(baserequirements.resource.baserequirements.IBaserequirementsTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new baserequirements.resource.baserequirements.ui.BaserequirementsOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new baserequirements.resource.baserequirements.ui.BaserequirementsPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			baserequirements.resource.baserequirements.IBaserequirementsTextResource textResource = (baserequirements.resource.baserequirements.IBaserequirementsTextResource) element.eResource();
			...
			baserequirements.resource.baserequirements.IBaserequirementsTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				baserequirements.resource.baserequirements.IBaserequirementsTextToken token = lexer.getNextToken();
			...
			baserequirements.resource.baserequirements.ui.BaserequirementsUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!BaserequirementsEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(baserequirements.resource.baserequirements.IBaserequirementsBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (baserequirements.resource.baserequirements.IBaserequirementsBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public baserequirements.resource.baserequirements.ui.IBaserequirementsBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(baserequirements.resource.baserequirements.ui.IBaserequirementsBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof baserequirements.resource.baserequirements.IBaserequirementsTextResource)) {
					return false;
				}
				baserequirements.resource.baserequirements.IBaserequirementsTextResource textResource = (baserequirements.resource.baserequirements.IBaserequirementsTextResource) resource;
				baserequirements.resource.baserequirements.IBaserequirementsLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
