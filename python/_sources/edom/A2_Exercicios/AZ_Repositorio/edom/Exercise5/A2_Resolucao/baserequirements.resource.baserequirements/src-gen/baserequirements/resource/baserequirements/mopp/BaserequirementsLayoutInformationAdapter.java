...
/**
 * A BaserequirementsLayoutInformationAdapter is used to store layout information
 ...
 * other tokens. BaserequirementsLayoutInformationAdapters are attached to
 ...
 */
public class BaserequirementsLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<baserequirements.resource.baserequirements.mopp.BaserequirementsLayoutInformation> layoutInformations = new java.util.ArrayList<baserequirements.resource.baserequirements.mopp.BaserequirementsLayoutInformation>();
	...
	public java.util.List<baserequirements.resource.baserequirements.mopp.BaserequirementsLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(baserequirements.resource.baserequirements.mopp.BaserequirementsLayoutInformation layoutInformation) {
