...
public class BaserequirementsNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "baserequirements.resource.baserequirements.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {baserequirements.resource.baserequirements.mopp.BaserequirementsBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(baserequirements.resource.baserequirements.mopp.BaserequirementsBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
