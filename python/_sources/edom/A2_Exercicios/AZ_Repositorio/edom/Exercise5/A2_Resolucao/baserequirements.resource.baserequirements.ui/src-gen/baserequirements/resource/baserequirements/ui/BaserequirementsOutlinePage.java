 ...
 */
public class BaserequirementsOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "baserequirements.resource.baserequirements.ui.outlinecontext";
	...
	public BaserequirementsOutlinePage(baserequirements.resource.baserequirements.IBaserequirementsResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new baserequirements.resource.baserequirements.ui.BaserequirementsOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new baserequirements.resource.baserequirements.ui.BaserequirementsOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("baserequirements.resource.baserequirements.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new baserequirements.resource.baserequirements.ui.BaserequirementsOutlinePageActionProvider().getActions(treeViewer);
