 ...
 */
public class BaserequirementsNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new baserequirements.resource.baserequirements.mopp.BaserequirementsMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public BaserequirementsNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("baserequirements.resource.baserequirements.ui");
							...
							String natureID = baserequirements.resource.baserequirements.mopp.BaserequirementsNature.NATURE_ID;
							...
							for (String builderID : baserequirements.resource.baserequirements.mopp.BaserequirementsNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								baserequirements.resource.baserequirements.mopp.BaserequirementsMetaInformation info = new baserequirements.resource.baserequirements.mopp.BaserequirementsMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = baserequirements.resource.baserequirements.ui.BaserequirementsUIPlugin.getDefault().getBundle();
