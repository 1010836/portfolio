 ...
 * @generated
 */
public class BasemindmapValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final BasemindmapValidator INSTANCE = new BasemindmapValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "basemindmap";
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			case BasemindmapPackage.MAP:
				return validateMap((basemindmap.Map)value, diagnostics, context);
			case BasemindmapPackage.TOPIC:
				return validateTopic((Topic)value, diagnostics, context);
			case BasemindmapPackage.MAP_ELEMENT:
				return validateMapElement((MapElement)value, diagnostics, context);
			case BasemindmapPackage.RELATIONSHIP:
	 ...
	 * @generated
	 */
	public boolean validateMap(basemindmap.Map map, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateMap_mustHaveTitle(basemindmap.Map map, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(BasemindmapPackage.Literals.MAP,
				 map,
				 diagnostics,
				 context,
	...
	public boolean validateTopic_EndAfterStart(Topic topic, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(BasemindmapPackage.Literals.TOPIC,
				 topic,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
