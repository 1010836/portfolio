 ...
 */
public class BaserequirementsCodeFoldingManager {
	
	private class FoldingUpdateListener implements baserequirements.resource.baserequirements.IBaserequirementsBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(baserequirements.resource.baserequirements.ui.BaserequirementsEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof baserequirements.resource.baserequirements.ui.BaserequirementsEditor) {
				baserequirements.resource.baserequirements.ui.BaserequirementsEditor editor = (baserequirements.resource.baserequirements.ui.BaserequirementsEditor) workbenchPart;
	...
	protected baserequirements.resource.baserequirements.ui.BaserequirementsEditor editor;
	 ...
	 */
	public BaserequirementsCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,baserequirements.resource.baserequirements.ui.BaserequirementsEditor textEditor) {
	...
	private void addCloseListener(final baserequirements.resource.baserequirements.ui.BaserequirementsEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			baserequirements.resource.baserequirements.ui.BaserequirementsUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		baserequirements.resource.baserequirements.IBaserequirementsTextResource textResource = (baserequirements.resource.baserequirements.IBaserequirementsTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
