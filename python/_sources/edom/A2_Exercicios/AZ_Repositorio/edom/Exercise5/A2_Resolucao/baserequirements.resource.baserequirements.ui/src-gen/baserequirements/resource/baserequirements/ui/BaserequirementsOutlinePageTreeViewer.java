 ...
 * a specified depth.
 */
public class BaserequirementsOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public BaserequirementsOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = baserequirements.resource.baserequirements.util.BaserequirementsStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof baserequirements.resource.baserequirements.ui.BaserequirementsEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			baserequirements.resource.baserequirements.mopp.BaserequirementsPlugin.logError("Exception while refreshing outline view", e);
		}
	}
