...
/**
 * BaserequirementsLayoutInformation objects are used to store layout information
 ...
 * other tokens.
 * BaserequirementsLayoutInformations are aggregated in LayoutInformationAdapters.
 * One BaserequirementsLayoutInformation contains the layout that was found before
 * a keyword, attribute or reference.
 */
public class BaserequirementsLayoutInformation {
	 ...
	 */
	private final baserequirements.resource.baserequirements.grammar.BaserequirementsSyntaxElement syntaxElement;
	...
	public BaserequirementsLayoutInformation(baserequirements.resource.baserequirements.grammar.BaserequirementsSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public baserequirements.resource.baserequirements.grammar.BaserequirementsSyntaxElement getSyntaxElement() {
