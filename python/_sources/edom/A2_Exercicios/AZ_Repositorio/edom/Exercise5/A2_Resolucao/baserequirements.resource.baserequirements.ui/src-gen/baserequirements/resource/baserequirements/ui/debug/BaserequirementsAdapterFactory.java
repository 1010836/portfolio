...
public class BaserequirementsAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new baserequirements.resource.baserequirements.mopp.BaserequirementsMetaInformation().getSyntaxName())) {
					return new baserequirements.resource.baserequirements.ui.debug.BaserequirementsLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof baserequirements.resource.baserequirements.debug.BaserequirementsDebugVariable) {
			final baserequirements.resource.baserequirements.debug.BaserequirementsDebugVariable variable = (baserequirements.resource.baserequirements.debug.BaserequirementsDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof baserequirements.resource.baserequirements.debug.BaserequirementsDebugVariable) {
			final baserequirements.resource.baserequirements.debug.BaserequirementsDebugVariable variable = (baserequirements.resource.baserequirements.debug.BaserequirementsDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							baserequirements.resource.baserequirements.debug.BaserequirementsDebugValue castedValue = (baserequirements.resource.baserequirements.debug.BaserequirementsDebugValue) value;
