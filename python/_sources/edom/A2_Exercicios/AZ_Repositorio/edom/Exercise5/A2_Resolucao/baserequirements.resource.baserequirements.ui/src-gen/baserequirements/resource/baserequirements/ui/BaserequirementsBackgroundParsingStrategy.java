 ...
 */
public class BaserequirementsBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final baserequirements.resource.baserequirements.IBaserequirementsTextResource resource, final baserequirements.resource.baserequirements.ui.BaserequirementsEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final baserequirements.resource.baserequirements.IBaserequirementsTextResource resource, final baserequirements.resource.baserequirements.ui.BaserequirementsEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final baserequirements.resource.baserequirements.IBaserequirementsTextResource resource, final baserequirements.resource.baserequirements.ui.BaserequirementsEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof baserequirements.resource.baserequirements.mopp.BaserequirementsResource) {
							baserequirements.resource.baserequirements.mopp.BaserequirementsResource concreteResource = (baserequirements.resource.baserequirements.mopp.BaserequirementsResource) resource;
