...
public class BaseRequirementsStackFrame extends baserequirements.resource.baseRequirements.debug.BaseRequirementsDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private baserequirements.resource.baseRequirements.debug.BaseRequirementsDebugTarget target;
	private String name;
	private int id;
	...
	public BaseRequirementsStackFrame(baserequirements.resource.baseRequirements.debug.BaseRequirementsDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = baserequirements.resource.baseRequirements.util.BaseRequirementsStringUtil.decode(data, ',');
	...
	private baserequirements.resource.baseRequirements.debug.BaseRequirementsDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		baserequirements.resource.baseRequirements.debug.BaseRequirementsStackFrame other = (baserequirements.resource.baseRequirements.debug.BaseRequirementsStackFrame) obj;
		if (name == null) {
