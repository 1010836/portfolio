 ...
 */
public class BaseRequirementsResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new baserequirements.resource.baseRequirements.util.BaseRequirementsInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new baserequirements.resource.baseRequirements.util.BaseRequirementsInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static baserequirements.resource.baseRequirements.mopp.BaseRequirementsResource getResource(java.io.File file) {
	...
	public static baserequirements.resource.baseRequirements.mopp.BaseRequirementsResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new baserequirements.resource.baseRequirements.mopp.BaseRequirementsMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (baserequirements.resource.baseRequirements.mopp.BaseRequirementsResource) resource;
	}
	 ...
	 */
	public static baserequirements.Model getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static baserequirements.Model getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (baserequirements.Model) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static baserequirements.Model getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		baserequirements.resource.baseRequirements.IBaseRequirementsTextResource resource = (baserequirements.resource.baseRequirements.IBaseRequirementsTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (baserequirements.resource.baseRequirements.IBaseRequirementsTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		baserequirements.resource.baseRequirements.IBaseRequirementsTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
