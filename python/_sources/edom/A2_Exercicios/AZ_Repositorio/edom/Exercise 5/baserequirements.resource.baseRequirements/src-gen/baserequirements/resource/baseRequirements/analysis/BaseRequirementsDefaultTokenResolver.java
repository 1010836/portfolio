 ...
 */
public class BaseRequirementsDefaultTokenResolver implements baserequirements.resource.baseRequirements.IBaseRequirementsTokenResolver {
	 ...
	 */
	public BaseRequirementsDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public BaseRequirementsDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, baserequirements.resource.baseRequirements.IBaseRequirementsTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : baserequirements.resource.baseRequirements.grammar.BaseRequirementsGrammarInformationProvider.INSTANCE.getKeywords()) {
