...
public abstract class BaseRequirementsQuickFix implements baserequirements.resource.baseRequirements.IBaseRequirementsQuickFix {
	...
	public BaseRequirementsQuickFix(String displayString, String imageKey, org.eclipse.emf.ecore.EObject contextObject) {
		this(displayString, imageKey, java.util.Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public BaseRequirementsQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public BaseRequirementsQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects, org.eclipse.emf.ecore.resource.Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new baserequirements.resource.baseRequirements.util.BaseRequirementsRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
