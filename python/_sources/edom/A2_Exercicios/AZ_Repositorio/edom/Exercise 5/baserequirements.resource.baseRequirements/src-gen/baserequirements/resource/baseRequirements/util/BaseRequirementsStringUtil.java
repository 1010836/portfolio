 ...
 */
public class BaseRequirementsStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, baserequirements.resource.baseRequirements.IBaseRequirementsFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, baserequirements.resource.baseRequirements.IBaseRequirementsFunction1<String, T> toStringFunction) {
