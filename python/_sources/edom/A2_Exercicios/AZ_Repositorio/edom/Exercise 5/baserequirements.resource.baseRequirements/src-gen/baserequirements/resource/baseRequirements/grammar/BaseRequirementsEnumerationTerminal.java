 ...
 */
public class BaseRequirementsEnumerationTerminal extends baserequirements.resource.baseRequirements.grammar.BaseRequirementsTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public BaseRequirementsEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, baserequirements.resource.baseRequirements.grammar.BaseRequirementsCardinality cardinality, int mandatoryOccurrencesAfter) {
