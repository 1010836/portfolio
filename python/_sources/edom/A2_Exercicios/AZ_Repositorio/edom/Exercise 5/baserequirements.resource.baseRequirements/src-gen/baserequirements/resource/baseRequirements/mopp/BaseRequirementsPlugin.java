 ...
 */
public class BaseRequirementsPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "baserequirements.resource.baseRequirements";
	/**
	...
	private static BaseRequirementsPlugin plugin;
	
	public BaseRequirementsPlugin() {
		super();
	}
	...
	public static BaseRequirementsPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, BaseRequirementsPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, BaseRequirementsPlugin.PLUGIN_ID, message);
		}
		final BaseRequirementsPlugin pluginInstance = BaseRequirementsPlugin.getDefault();
