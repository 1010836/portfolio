...
public class BaseRequirementsDebugValue extends baserequirements.resource.baseRequirements.debug.BaseRequirementsDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public BaseRequirementsDebugValue(baserequirements.resource.baseRequirements.debug.BaseRequirementsDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
