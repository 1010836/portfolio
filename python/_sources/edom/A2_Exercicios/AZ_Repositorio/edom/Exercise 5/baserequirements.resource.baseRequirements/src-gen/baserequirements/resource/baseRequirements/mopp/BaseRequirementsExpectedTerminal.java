 ...
 */
public class BaseRequirementsExpectedTerminal {
	...
	private baserequirements.resource.baseRequirements.IBaseRequirementsExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private baserequirements.resource.baseRequirements.grammar.BaseRequirementsContainmentTrace containmentTrace;
	
	public BaseRequirementsExpectedTerminal(org.eclipse.emf.ecore.EObject container, baserequirements.resource.baseRequirements.IBaseRequirementsExpectedElement terminal, int followSetID, baserequirements.resource.baseRequirements.grammar.BaseRequirementsContainmentTrace containmentTrace) {
		super();
	...
	public baserequirements.resource.baseRequirements.IBaseRequirementsExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		BaseRequirementsExpectedTerminal otherExpectedTerminal = (BaseRequirementsExpectedTerminal) o;
	...
	public baserequirements.resource.baseRequirements.grammar.BaseRequirementsContainmentTrace getContainmentTrace() {
