 ...
 * resolver
 */
public interface IBaseRequirementsReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends baserequirements.resource.baseRequirements.IBaseRequirementsConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, baserequirements.resource.baseRequirements.IBaseRequirementsReferenceResolveResult<ReferenceType> result);
