 ...
 */
public class BaseRequirementsHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public BaseRequirementsHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				baserequirements.resource.baseRequirements.mopp.BaseRequirementsPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
