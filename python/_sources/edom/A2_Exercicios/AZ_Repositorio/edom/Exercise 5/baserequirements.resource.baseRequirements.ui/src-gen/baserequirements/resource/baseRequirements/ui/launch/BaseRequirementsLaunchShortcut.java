 ...
 */
public class BaseRequirementsLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new baserequirements.resource.baseRequirements.mopp.BaseRequirementsMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(baserequirements.resource.baseRequirements.launch.BaseRequirementsLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			baserequirements.resource.baseRequirements.mopp.BaseRequirementsPlugin.logError("Exception while launching selection", e);
		}
	}
