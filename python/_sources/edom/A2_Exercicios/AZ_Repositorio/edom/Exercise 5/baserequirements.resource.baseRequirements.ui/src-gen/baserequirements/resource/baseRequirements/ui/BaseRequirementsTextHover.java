 ...
 */
public class BaseRequirementsTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private baserequirements.resource.baseRequirements.IBaseRequirementsHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput infoInput = (baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					baserequirements.resource.baseRequirements.ui.BaseRequirementsHyperlink hyperlink = new baserequirements.resource.baseRequirements.ui.BaseRequirementsHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl iControl = new baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput) {
							baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput input = (baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl.isAvailable(parent)) {
				baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl iControl = new baserequirements.resource.baseRequirements.ui.BaseRequirementsBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public BaseRequirementsTextHover(baserequirements.resource.baseRequirements.IBaseRequirementsResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new baserequirements.resource.baseRequirements.ui.BaseRequirementsUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				baserequirements.resource.baseRequirements.ui.BaseRequirementsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			baserequirements.resource.baseRequirements.ui.BaseRequirementsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			baserequirements.resource.baseRequirements.ui.BaseRequirementsHTMLPrinter.insertPageProlog(buffer, 0, baserequirements.resource.baseRequirements.ui.BaseRequirementsTextHover.getStyleSheet());
			baserequirements.resource.baseRequirements.ui.BaseRequirementsHTMLPrinter.addPageEpilog(buffer);
			return new baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = baserequirements.resource.baseRequirements.ui.BaseRequirementsHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(baserequirements.resource.baseRequirements.ui.BaseRequirementsUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return baserequirements.resource.baseRequirements.util.BaseRequirementsStreamUtil.getContent(styleSheetURL.openStream());
