 ...
 */
public class BaseRequirementsImageProvider {
	
	public final static BaseRequirementsImageProvider INSTANCE = new BaseRequirementsImageProvider();
	...
	public org.eclipse.jface.resource.ImageDescriptor getImageDescriptor(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(baserequirements.resource.baseRequirements.ui.BaseRequirementsUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				baserequirements.resource.baseRequirements.ui.BaseRequirementsUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
