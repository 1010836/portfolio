 ...
 */
public class BaseRequirementsSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public BaseRequirementsSyntaxColoringPreferencePage() {
		super();
		
		baserequirements.resource.baseRequirements.mopp.BaseRequirementsMetaInformation metaInformation = new baserequirements.resource.baseRequirements.mopp.BaseRequirementsMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, baserequirements.resource.baseRequirements.ui.BaseRequirementsSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		baserequirements.resource.baseRequirements.ui.BaseRequirementsPixelConverter pixelConverter = new baserequirements.resource.baseRequirements.ui.BaseRequirementsPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof baserequirements.resource.baseRequirements.ui.BaseRequirementsEditor) {
			baserequirements.resource.baseRequirements.ui.BaseRequirementsEditor emfTextEditor = (baserequirements.resource.baseRequirements.ui.BaseRequirementsEditor) editor;
