 ...
 * class.
 */
public class BaseRequirementsLaunchConfigurationMainTab extends org.eclipse.debug.ui.AbstractLaunchConfigurationTab {
	...
	public void initializeFrom(org.eclipse.debug.core.ILaunchConfiguration configuration) {
		try {
			uriText.setText(configuration.getAttribute(baserequirements.resource.baseRequirements.launch.BaseRequirementsLaunchConfigurationDelegate.ATTR_RESOURCE_URI, ""));
			// more initialization code can be added here
		} catch (org.eclipse.core.runtime.CoreException e) {
			baserequirements.resource.baseRequirements.mopp.BaseRequirementsPlugin.logError("Can't initialize launch configuration tab.", e);
		}
	}
	
	public void performApply(org.eclipse.debug.core.ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(baserequirements.resource.baseRequirements.launch.BaseRequirementsLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uriText.getText());
	}
	...
	public org.eclipse.swt.graphics.Image getImage() {
		return baserequirements.resource.baseRequirements.ui.BaseRequirementsImageProvider.INSTANCE.getImage("icons/launch_tab_main_icon.gif");
	}
	...
	protected void handleBrowseWorkspace() {
		...
		dialog.addFilter(new org.eclipse.jface.viewers.ViewerFilter() {
			...
			public boolean select(org.eclipse.jface.viewers.Viewer viewer, Object parentElement, Object element) {
				if (element instanceof org.eclipse.core.resources.IFile) {
					...
					return file.getFileExtension().equals(new baserequirements.resource.baseRequirements.mopp.BaseRequirementsMetaInformation().getSyntaxName());
				}
				return true;
			}
		});
		...
		dialog.setValidator(new org.eclipse.ui.dialogs.ISelectionStatusValidator() {
			public org.eclipse.core.runtime.IStatus validate(Object[] selection) {
				if (selection.length > 0 && selection[0] instanceof org.eclipse.core.resources.IFile)				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.OK, baserequirements.resource.baseRequirements.ui.BaseRequirementsUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.OK, "", null);
				
				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, baserequirements.resource.baseRequirements.ui.BaseRequirementsUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.ERROR, "", null);
			}
		});
