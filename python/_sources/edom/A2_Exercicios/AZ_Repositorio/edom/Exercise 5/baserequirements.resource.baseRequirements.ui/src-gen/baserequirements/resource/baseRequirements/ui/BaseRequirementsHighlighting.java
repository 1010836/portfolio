 ...
 */
public class BaseRequirementsHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static baserequirements.resource.baseRequirements.ui.BaseRequirementsPositionHelper positionHelper = new baserequirements.resource.baseRequirements.ui.BaseRequirementsPositionHelper();
	...
	private baserequirements.resource.baseRequirements.ui.BaseRequirementsTokenScanner scanner;
	...
	private baserequirements.resource.baseRequirements.ui.BaseRequirementsEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private baserequirements.resource.baseRequirements.ui.BaseRequirementsOccurrence occurrence;
	private baserequirements.resource.baseRequirements.ui.BaseRequirementsBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, baserequirements.resource.baseRequirements.IBaseRequirementsBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public BaseRequirementsHighlighting(baserequirements.resource.baseRequirements.IBaseRequirementsTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, baserequirements.resource.baseRequirements.ui.BaseRequirementsColorManager colorManager, baserequirements.resource.baseRequirements.ui.BaseRequirementsEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = baserequirements.resource.baseRequirements.ui.BaseRequirementsUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new baserequirements.resource.baseRequirements.ui.BaseRequirementsTokenScanner(textResource, colorManager);
		occurrence = new baserequirements.resource.baseRequirements.ui.BaseRequirementsOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new baserequirements.resource.baseRequirements.ui.BaseRequirementsBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(baserequirements.resource.baseRequirements.ui.BaseRequirementsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, baserequirements.resource.baseRequirements.ui.BaseRequirementsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(baserequirements.resource.baseRequirements.ui.BaseRequirementsEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, baserequirements.resource.baseRequirements.ui.BaseRequirementsPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, baserequirements.resource.baseRequirements.ui.BaseRequirementsPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(baserequirements.resource.baseRequirements.ui.BaseRequirementsPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new baserequirements.resource.baseRequirements.ui.BaseRequirementsEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
