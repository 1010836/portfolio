 ...
 */
public class BaseRequirementsNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public BaseRequirementsNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new baseRequirements file");
