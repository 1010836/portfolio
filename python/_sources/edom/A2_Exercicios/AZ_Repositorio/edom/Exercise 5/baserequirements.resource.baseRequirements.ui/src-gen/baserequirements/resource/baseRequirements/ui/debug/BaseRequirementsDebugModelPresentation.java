...
public class BaseRequirementsDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public BaseRequirementsDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return baserequirements.resource.baseRequirements.ui.BaseRequirementsUIPlugin.EDITOR_ID;
		}
		return null;
	}
