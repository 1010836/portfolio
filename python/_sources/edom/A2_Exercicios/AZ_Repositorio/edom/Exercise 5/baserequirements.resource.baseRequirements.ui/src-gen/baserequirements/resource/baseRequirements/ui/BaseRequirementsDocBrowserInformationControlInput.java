 ...
 * olInput</code>.
 */
public class BaseRequirementsDocBrowserInformationControlInput {
	
	private final BaseRequirementsDocBrowserInformationControlInput fPrevious;
	private BaseRequirementsDocBrowserInformationControlInput fNext;
	 ...
	 */
	public BaseRequirementsDocBrowserInformationControlInput(BaseRequirementsDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public BaseRequirementsDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public BaseRequirementsDocBrowserInformationControlInput getNext() {
		return fNext;
	}
