 ...
 * @since 3.2
 */
public class BaseRequirementsBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput fInput;
	 ...
	 */
	public BaseRequirementsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public BaseRequirementsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public BaseRequirementsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput);
		...
		fInput= (baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput) input;
		...
		baserequirements.resource.baseRequirements.ui.BaseRequirementsHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = baserequirements.resource.baseRequirements.ui.BaseRequirementsHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public baserequirements.resource.baseRequirements.ui.BaseRequirementsDocBrowserInformationControlInput getInput() {
		return fInput;
	}
