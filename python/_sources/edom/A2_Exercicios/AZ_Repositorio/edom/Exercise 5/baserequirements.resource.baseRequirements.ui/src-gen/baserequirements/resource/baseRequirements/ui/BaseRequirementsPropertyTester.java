...
public class BaseRequirementsPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new baserequirements.resource.baseRequirements.mopp.BaseRequirementsMetaInformation().getSyntaxName());
	}
