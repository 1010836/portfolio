 ...
 */
public class BaseRequirementsUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "baserequirements.resource.baseRequirements.ui";
	public static final String EDITOR_ID = "baserequirements.resource.baseRequirements.ui.BaseRequirementsEditor";
	...
	private static BaseRequirementsUIPlugin plugin;
	
	public BaseRequirementsUIPlugin() {
		super();
	}
	...
	public static BaseRequirementsUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BaseRequirementsUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BaseRequirementsUIPlugin.PLUGIN_ID, message);
		}
		final BaseRequirementsUIPlugin pluginInstance = BaseRequirementsUIPlugin.getDefault();
