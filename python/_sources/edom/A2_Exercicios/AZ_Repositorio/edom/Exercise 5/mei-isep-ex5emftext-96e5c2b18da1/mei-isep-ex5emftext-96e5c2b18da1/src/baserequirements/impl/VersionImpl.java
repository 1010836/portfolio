 ...
 * </p>
 * <ul>
 *   <li>{@link baserequirements.impl.VersionImpl#getMajor <em>Major</em>}</li>
 *   <li>{@link baserequirements.impl.VersionImpl#getMinor <em>Minor</em>}</li>
 *   <li>{@link baserequirements.impl.VersionImpl#getService <em>Service</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionImpl extends MinimalEObjectImpl.Container implements Version {
	...
	protected EClass eStaticClass() {
		return BaserequirementsPackage.Literals.VERSION;
	}
	...
	public void setMajor(int newMajor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaserequirementsPackage.VERSION__MAJOR, oldMajor, major));
	}
	...
	public void setMinor(int newMinor) {
		...
		minor = newMinor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaserequirementsPackage.VERSION__MINOR, oldMinor, minor));
	}
	...
	public void setService(int newService) {
		...
		service = newService;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaserequirementsPackage.VERSION__SERVICE, oldService, service));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BaserequirementsPackage.VERSION__MAJOR:
				return getMajor();
			case BaserequirementsPackage.VERSION__MINOR:
				return getMinor();
			case BaserequirementsPackage.VERSION__SERVICE:
				return getService();
		}
