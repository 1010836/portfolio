 ...
 * <!-- end-user-doc -->
 * @see mindmapBase.MindmapBasePackage
 * @generated
 */
public class MindmapBaseValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final MindmapBaseValidator INSTANCE = new MindmapBaseValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "mindmapBase";
	...
	protected EPackage getEPackage() {
	  return MindmapBasePackage.eINSTANCE;
	}
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			case MindmapBasePackage.MAP:
				return validateMap((mindmapBase.Map)value, diagnostics, context);
			case MindmapBasePackage.RELATIONSHIP:
				return validateRelationship((Relationship)value, diagnostics, context);
			case MindmapBasePackage.TOPIC:
				return validateTopic((Topic)value, diagnostics, context);
			case MindmapBasePackage.MAP_ELEMENT:
				return validateMapElement((MapElement)value, diagnostics, context);
			case MindmapBasePackage.PRIORITY:
				return validatePriority((Priority)value, diagnostics, context);
			case MindmapBasePackage.TYPE:
	 ...
	 * @generated
	 */
	public boolean validateMap(mindmapBase.Map map, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateMap_mustHaveTitle(map, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateMap_mustHaveTitle(mindmapBase.Map map, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(MindmapBasePackage.Literals.MAP,
				 map,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "mustHaveTitle",
				 MAP__MUST_HAVE_TITLE__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	...
	public boolean validateTopic(Topic topic, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateTopic_EndAfterStart(topic, diagnostics, context);
		return result;
	}
	...
	public boolean validateTopic_EndAfterStart(Topic topic, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(MindmapBasePackage.Literals.TOPIC,
				 topic,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "EndAfterStart",
				 TOPIC__END_AFTER_START__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
