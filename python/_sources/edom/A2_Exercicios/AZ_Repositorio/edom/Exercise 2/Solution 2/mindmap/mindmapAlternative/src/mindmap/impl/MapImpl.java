...
public class MapImpl extends MinimalEObjectImpl.Container implements Map {
	 ...
	 * @ordered
	 */
	protected EList<Topic> elements;
	 ...
	 * @generated
	 */
	public EList<Topic> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Topic>(Topic.class, this, MindmapPackage.MAP__ELEMENTS);
		}
		return elements;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MindmapPackage.MAP__ELEMENTS:
				getElements().clear();
				getElements().addAll((Collection<? extends Topic>)newValue);
				return;
		}
