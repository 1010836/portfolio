...
public class MindmapFactoryImpl extends EFactoryImpl implements MindmapFactory {
	...
	public static MindmapFactory init() {
		try {
			MindmapFactory theMindmapFactory = (MindmapFactory)EPackage.Registry.INSTANCE.getEFactory(MindmapPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case MindmapPackage.LINK: return createLink();
			default:
