 ...
 *   <li>{@link requirements.impl.CommentImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommentImpl extends MinimalEObjectImpl.Container implements Comment {
	...
	public EList<Comment> getChildren() {
		if (children == null) {
			children = new EObjectResolvingEList<Comment>(Comment.class, this, RequirementsPackage.COMMENT__CHILDREN);
		}
		return children;
	}
