...
/**
 * This is the item provider adapter for a {@link mindmap.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MindmapPackage.Literals.LINK__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MindmapPackage.Literals.LINK__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Link.class)) {
			case MindmapPackage.LINK__NAME:
	...
	public ResourceLocator getResourceLocator() {
		return MindmapAlternativeEditPlugin.INSTANCE;
	}
